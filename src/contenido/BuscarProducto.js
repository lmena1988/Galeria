...
export default class BuscarUsuario extends Component {
  ...
  <div className="container-fluid">
    ...
    <li>
      ...
      <li>
        <Link href="/ListarProductos"><i className="fas fa-clipboard-list fa-fw" /> &nbsp; LISTA DE PRODUCTOS</Link>
      </li>
      <li>
        <Link className='active' to="/BuscarProducto"><i className="fas fa-search fa-fw" /> &nbsp; BUSCAR PRODUCTO</Link>
      </li>
    </ul>	
  </div>
  {/* Content */}
        ...
        <div className="row justify-content-md-center">
          <div className="col-12 col-md-6">
            <div className="form-group">
              <label htmlFor="inputSearch" className="bmd-label-floating">¿Qué producto estás buscando?</label>
