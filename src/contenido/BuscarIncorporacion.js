...
export default class BuscarIncorporacion extends Component {
  render() {
	return (
	  <div>
      <Header/>
  ...
  <div className="full-box page-header">
    <h3 className="text-left">
      <i className="fas fa-search fa-fw" /> &nbsp; BUSCAR INCORPORACIÓN
    </h3>
  ...
  <div className="container-fluid">
    ...
    <li>
      ...
      <li>
        <Link className='active' to="/BuscarIncorporacion"><i className="fas fa-search fa-fw" /> &nbsp; BUSCAR INCORPORACIÓN</Link>
      </li>
    </ul>	
  </div>
  {/* Content */}
        ...
        <div className="row justify-content-md-center">
          <div className="col-12 col-md-6">
            <div className="form-group">
              <label htmlFor="inputSearch" className="bmd-label-floating">¿Qué incorporación estás buscando?</label>
