...
export default class BuscarPrecio extends Component {
  render() {
	return (
	  <div>
      <Header/>
  ...
  <div className="container-fluid">
    ...
    <li>
      ...
      <li>
        <Link className='active' to="/BuscarPrecio"><i className="fas fa-search fa-fw" /> &nbsp; BUSCAR PRECIO</Link>
      </li>
    </ul>	
  </div>
  {/* Content */}
        ...
        <div className="row justify-content-md-center">
          <div className="col-12 col-md-6">
            <div className="form-group">
              <label htmlFor="inputSearch" className="bmd-label-floating">¿Qué precio estás buscando?</label>
