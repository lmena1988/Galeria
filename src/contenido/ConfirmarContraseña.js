                          ...
                          <tr>
                            <td style={{overflowWrap: 'break-word', wordBreak: 'break-word', padding: '40px 40px 30px', fontFamily: '"Lato",sans-serif'}} align="left">
                              <div style={{lineHeight: '140%', textAlign: 'center', wordWrap: 'break-word'}}>
                                <p style={{fontSize: 14, lineHeight: '140%'}}><span style={{fontSize: 14, lineHeight: '25.2px', color: '#666666'}}>Ingrese el código validador entregado en su correo.</span></p>
                          ...
                          <tr>
                            <td style={{overflowWrap: 'break-word', wordBreak: 'break-word', padding: '0px 40px', fontFamily: '"Lato",sans-serif'}} align="left">
                              ...
                              <div align="center">
                                ...
                                <br></br>
                                <br></br>
                                <Link to="/NuevaContraseña" className="v-button" style={{boxSizing: 'border-box', display: 'inline-block', fontFamily: '"Lato",sans-serif', textDecoration: 'none', WebkitTextSizeAdjust: 'none', textAlign: 'center', color: '#FFFFFF', backgroundColor: '#18163a', borderRadius: 1, WebkitBorderRadius: 1, MozBorderRadius: 1, width: 'auto', maxWidth: '100%', overflowWrap: 'break-word', wordBreak: 'break-word', wordWrap: 'break-word', msoBorderAlt: 'none'}}>
                                  <span style={{display: 'block', padding: '15px 40px', lineHeight: '120%'}}><span style={{fontSize: 18, lineHeight: '21.6px'}}>Validar</span></span>
                                </Link>
                                <Link to="/RecuperarContraseña" className="v-button" style={{boxSizing: 'border-box', display: 'inline-block',marginLeft: 10, fontFamily: '"Lato",sans-serif', textDecoration: 'none', WebkitTextSizeAdjust: 'none', textAlign: 'center', color: '#FFFFFF', backgroundColor: '#18163a', borderRadius: 1, WebkitBorderRadius: 1, MozBorderRadius: 1, width: 'auto', maxWidth: '100%', overflowWrap: 'break-word', wordBreak: 'break-word', wordWrap: 'break-word', msoBorderAlt: 'none'}}>
